...
COMMENT ON COLUMN PERSON.IDCARD_NO IS '身份证号';
COMMENT ON COLUMN PERSON.NAME IS '姓名';
COMMENT ON COLUMN PERSON.GENDER IS '性别 M:男性 F:女性 空：未知';
COMMENT ON COLUMN PERSON.BIRTH_DATE IS '出生日期';
COMMENT ON COLUMN PERSON.AGE IS '年龄';
COMMENT ON COLUMN PERSON.NATIVE_PLACE_CODE IS '籍贯';
COMMENT ON COLUMN PERSON.HOME_ADDRESS IS '家庭地址';
COMMENT ON COLUMN PERSON.WORK_ADDRESS IS '工作地址';
COMMENT ON COLUMN PERSON.PROFESSION_CODE IS '职业编码';
COMMENT ON COLUMN PERSON.GRANDUATE_SCHOOL_CODE IS '毕业学校编码';
COMMENT ON COLUMN PERSON.CREATED_DATE IS '创建时间';
COMMENT ON COLUMN PERSON.CREATED_BY IS '创建人';
COMMENT ON COLUMN PERSON.UPATE_DATE IS '更新时间';
COMMENT ON COLUMN PERSON.UPDATE_BY IS '更新人';
